...
cout<<"-----------------------------------------"<<endl;
    ...
    cout << "Number of cards each player before start game:  " << endl << player1.getName() << " : "
         << player1.stacksize() << endl << player2.getName() << " : " << player2.stacksize() << endl;
    cout << "Number of cards taken each player before start game:  " << endl << player1.getName() << " : "
         << player1.cardesTaken() << endl << player2.getName() << " : " << player2.cardesTaken() << endl;
    cout<<"Check if the player's (1,2) name are equal: "<<player1.getName()<<" == " <<player2.getName() << "? " <<(player1 == player2)<<endl;
    cout<<"Check if the player's (1,3) name are equal: "<<player1.getName()<<" == " <<player3.getName() << "? " <<(player1 == player3)<<endl;
    cout<<"Check the Deck's players before the game begin: "<<endl<<player1.getName()<<" : "<<player1.getDeck().size()<<endl<<player2.getName()<<" : "<<player2.getDeck().size()<<endl;
    cout<<"Check statistic info of each player before the game begin: "<<endl<<player1.getName()<<" : "<<"[Wins:"<<player1.getWinsNum()<<",Lose:"<<player1.getLoseNum()<<",Draw:"<<player1.getDrawNum()<<"]"<<endl<<player2.getName()<<" : "<<"[Wins:"<<player2.getWinsNum()<<",Lose:"<<player2.getLoseNum()<<",Draw:"<<player2.getDrawNum()<<"]"<<endl;
    cout<<"----------------------------------------"<<endl;
    cout<<"Check player class after play turn game:"<<endl;
    cout<<"----------------------------------------"<<endl;
    Game game (player1,player2);
    game.playTurn();
    cout << "Number of cards each player after play turn:  " << endl << player1.getName() << " : "
         << player1.stacksize() << endl << player2.getName() << " : " << player2.stacksize() << endl;
    cout << "Number of cards taken each player after play turn:  " << endl << player1.getName() << " : "
         << player1.cardesTaken() << endl << player2.getName() << " : " << player2.cardesTaken() << endl;
    cout<<"Check the Deck's players after play turn: "<<endl<<player1.getName()<<" : "<<player1.getDeck().size()<<endl<<player2.getName()<<" : "<<player2.getDeck().size()<<endl;
    cout<<"Check statistic info of each player after play turn: "<<endl<<player1.getName()<<" : "<<"[Wins:"<<player1.getWinsNum()<<",Lose:"<<player1.getLoseNum()<<",Draw:"<<player1.getDrawNum()<<"]"<<endl<<player2.getName()<<" : "<<"[Wins:"<<player2.getWinsNum()<<",Lose:"<<player2.getLoseNum()<<",Draw:"<<player2.getDrawNum()<<"]"<<endl;
    cout<<"------------------"<<endl;
    cout<<"Check Card class :"<<endl;
    cout<<"------------------"<<endl;
    Card card1(ariel::ace,ariel::diamonds);
    Card card2(ariel::two,ariel::clubs);
    cout<<"Check the cards value and suit: "<<endl<<"Card1: ["<<card1.getValueName()<<","<<card1.getSuitName()<<"]"<<endl<<"Card2 ["<<card2.getValueName()<<","<<card2.getSuitName()<<"]"<<endl;
    cout<<"Check the print method work properly: "<<endl;
    card1.printCard();
    cout<<endl;
    card2.printCard();
    cout<<endl;
    cout<<"Check the compare method: "<<endl;
    ...
    deck.printDeck();
    Deck deck2;
    cout<<"Shuffle and print again the deck: "<<endl;
    deck.shuffle();
    deck.printDeck();
    ...
    std::cout << "The size of the deck is: " << deck.size()<< std::endl;
    deck.resetDeck();
    std::cout << "The size of the deck after reset: " << deck.size() << std::endl;
